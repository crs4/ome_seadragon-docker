...
ADD 80-configure-ome_seadragon.sh /startup/

# ENV PYTHONPATH "${PYTHONPATH}:/opt/ome_seadragon/"

# RUN pip install corsheaders
...
RUN pip install --user --upgrade pip openslide-python Pillow lxml requests
